...
func (p *Processor) Do() error {
	...
	pkgs, err := parser.ParseDir(fset, filepath.Join(p.Dir, "service"), skipGenerated, parser.ParseComments)
	if err != nil {
		return err
	}
...
func (p *Processor) ProcessPkg(pkg *ast.Package) error {
	...
	buf := bytes.Buffer{}
	buf.WriteString("// Automatically generated by gentransport utility. DO NOT EDIT!\n")
	...
	// consolidation/
	fn := filepath.Join(p.Dir, "service", "transport_gen.go")
	if pdebug.Enabled {
