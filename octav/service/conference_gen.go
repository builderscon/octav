...
func (v *Conference) Create(tx *db.Tx, vdb *db.Conference, payload CreateConferenceRequest) (err error) {
	if pdebug.Enabled {
...
func (v *Conference) Update(tx *db.Tx, vdb *db.Conference, payload UpdateConferenceRequest) (err error) {
	if pdebug.Enabled {
