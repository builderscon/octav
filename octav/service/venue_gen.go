...
func (v *Venue) LookupFromPayload(tx *db.Tx, m *model.Venue, payload model.LookupVenueRequest) (err error) {
	if pdebug.Enabled {
...
func (v *Venue) Lookup(tx *db.Tx, m *model.Venue, id string) (err error) {
	if pdebug.Enabled {
