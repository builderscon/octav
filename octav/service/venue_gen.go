...
func (v *Venue) Create(tx *db.Tx, vdb *db.Venue, payload CreateVenueRequest) (err error) {
	if pdebug.Enabled {
...
func (v *Venue) Update(tx *db.Tx, vdb *db.Venue, payload UpdateVenueRequest) (err error) {
	if pdebug.Enabled {
