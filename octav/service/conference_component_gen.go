...
func (v *ConferenceComponent) LookupFromPayload(tx *db.Tx, m *model.ConferenceComponent, payload model.LookupConferenceComponentRequest) (err error) {
	if pdebug.Enabled {
...
func (v *ConferenceComponent) Lookup(tx *db.Tx, m *model.ConferenceComponent, id string) (err error) {
	if pdebug.Enabled {
...
func (v *ConferenceComponent) Create(tx *db.Tx, vdb *db.ConferenceComponent, payload model.CreateConferenceComponentRequest) (err error) {
	if pdebug.Enabled {
...
func (v *ConferenceComponent) Update(tx *db.Tx, vdb *db.ConferenceComponent, payload model.UpdateConferenceComponentRequest) (err error) {
	if pdebug.Enabled {
...
func (v *ConferenceComponent) Delete(tx *db.Tx, id string) error {
	if pdebug.Enabled {
...
func (v *ConferenceComponent) LoadList(tx *db.Tx, vdbl *db.ConferenceComponentList, since string, limit int) error {
