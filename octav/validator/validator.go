...
func init() {
	...
	R23 = jsval.String().Enum("XXXL", "XXL", "XL", "L", "M", "S", "XS")
	R24 = jsval.String().Format("url")
	R25 = jsval.String().RegexpString(`^[a-fA-F0-9-]+$`)
	R26 = jsval.String().RegexpString(`^[a-fA-F0-9-]+$`).Default("")
	R27 = jsval.Object().
		AdditionalProperties(
			jsval.EmptyConstraint,
		).
	...
	M.SetReference(`#/definitions/tag`, R21)
	M.SetReference(`#/definitions/tag-array`, R22)
	M.SetReference(`#/definitions/tshirt_size`, R23)
	M.SetReference(`#/definitions/url`, R24)
	M.SetReference(`#/definitions/uuid`, R25)
	M.SetReference(`#/definitions/uuidDefaultEmpty`, R26)
	M.SetReference(`#/definitions/venue`, R27)
