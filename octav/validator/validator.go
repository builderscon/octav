// DO NOT EDIT. Automatically generated by hsup at Tue, 08 Mar 2016 15:07:03 JST
package validator
...
func init() {
	...
	R11 = jsval.String()
	R12 = jsval.String()
	R13 = jsval.String().Enum("beginner", "intermediate", "advanced")
	R14 = jsval.Integer().Minimum(0)
	R15 = jsval.Object().
		AdditionalProperties(
			jsval.EmptyConstraint,
		).
	...
	R22 = jsval.String().Enum("XXXL", "XXL", "XL", "L", "M", "S", "XS")
	R23 = jsval.String().Format("url")
	R24 = jsval.String().RegexpString(`^[a-fA-F0-9-]+$`)
	R25 = jsval.String().RegexpString(`^[a-fA-F0-9-]+$`).Default("")
	R26 = jsval.Object().
		AdditionalProperties(
			jsval.EmptyConstraint,
		).
	...
	M.SetReference(`#/definitions/markdown-i18n`, R12)
	M.SetReference(`#/definitions/material-level`, R13)
	M.SetReference(`#/definitions/positiveInteger`, R14)
	M.SetReference(`#/definitions/room`, R15)
	M.SetReference(`#/definitions/session`, R16)
	M.SetReference(`#/definitions/speaker`, R17)
	M.SetReference(`#/definitions/speaker-array`, R18)
	M.SetReference(`#/definitions/string-en`, R19)
	M.SetReference(`#/definitions/string-i18n`, R20)
	M.SetReference(`#/definitions/tag-array`, R21)
	M.SetReference(`#/definitions/tshirt_size`, R22)
	M.SetReference(`#/definitions/url`, R23)
	M.SetReference(`#/definitions/uuid`, R24)
	M.SetReference(`#/definitions/uuidDefaultEmpty`, R25)
	M.SetReference(`#/definitions/venue`, R26)
