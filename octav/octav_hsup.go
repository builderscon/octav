...
func (s *Server) SetupRoutes() {
	...
	r.HandleFunc(`/v1/featured_speaker/list`, httpWithContext(httpListFeaturedSpeakers))
	r.HandleFunc(`/v1/featured_speaker/lookup`, httpWithContext(httpLookupFeaturedSpeaker))
	...
	r.HandleFunc(`/v1/session_type/list`, httpWithContext(httpListSessionTypesByConference))
	r.HandleFunc(`/v1/session_type/lookup`, httpWithContext(httpLookupSessionType))
	...
	r.HandleFunc(`/v1/sponsor/list`, httpWithContext(httpListSponsors))
	r.HandleFunc(`/v1/sponsor/lookup`, httpWithContext(httpLookupSponsor))
	...
	r.HandleFunc(`/v1/user/lookup_user_by_auth_user_id`, httpWithContext(httpLookupUserByAuthUserID))
