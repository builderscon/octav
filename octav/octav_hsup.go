...
func (s *Server) SetupRoutes() {
	...
	r.HandleFunc(`/v2/blog_entry/create`, httpWithContext(httpWithBasicAuth(httpCreateBlogEntry)))
	r.HandleFunc(`/v2/blog_entry/delete`, httpWithContext(httpWithBasicAuth(httpDeleteBlogEntry)))
	...
	r.HandleFunc(`/v2/blog_entry/update`, httpWithContext(httpWithBasicAuth(httpUpdateBlogEntry)))
	r.HandleFunc(`/v2/client/session`, httpWithContext(httpCreateClientSession))
	r.HandleFunc(`/v2/conference/admin/add`, httpWithContext(httpWithBasicAuth(httpAddConferenceAdmin)))
	r.HandleFunc(`/v2/conference/admin/delete`, httpWithContext(httpWithBasicAuth(httpDeleteConferenceAdmin)))
	r.HandleFunc(`/v2/conference/admin/list`, httpWithContext(httpWithBasicAuth(httpListConferenceAdmin)))
	r.HandleFunc(`/v2/conference/create`, httpWithContext(httpWithBasicAuth(httpCreateConference)))
	r.HandleFunc(`/v2/conference/credentials/add`, httpWithContext(httpWithBasicAuth(httpAddConferenceCredential)))
	r.HandleFunc(`/v2/conference/date/add`, httpWithContext(httpWithBasicAuth(httpAddConferenceDate)))
	r.HandleFunc(`/v2/conference/date/delete`, httpWithContext(httpDeleteConferenceDate))
	r.HandleFunc(`/v2/conference/date/list`, httpWithContext(httpWithBasicAuth(httpListConferenceDate)))
	r.HandleFunc(`/v2/conference/delete`, httpWithContext(httpWithBasicAuth(httpDeleteConference)))
	...
	r.HandleFunc(`/v2/conference/session_type/add`, httpWithContext(httpWithBasicAuth(httpAddSessionType)))
	r.HandleFunc(`/v2/conference/staff/add`, httpWithContext(httpWithBasicAuth(httpAddConferenceStaff)))
	r.HandleFunc(`/v2/conference/staff/delete`, httpWithContext(httpWithBasicAuth(httpDeleteConferenceStaff)))
	r.HandleFunc(`/v2/conference/staff/list`, httpWithContext(httpWithOptionalBasicAuth(httpListConferenceStaff)))
	r.HandleFunc(`/v2/conference/tweet`, httpWithContext(httpWithBasicAuth(httpTweetAsConference)))
	r.HandleFunc(`/v2/conference/update`, httpWithContext(httpWithBasicAuth(httpUpdateConference)))
	r.HandleFunc(`/v2/conference/venue/add`, httpWithContext(httpWithBasicAuth(httpAddConferenceVenue)))
	r.HandleFunc(`/v2/conference/venue/delete`, httpWithContext(httpWithBasicAuth(httpDeleteConferenceVenue)))
	r.HandleFunc(`/v2/conference_series/admin/add`, httpWithContext(httpWithBasicAuth(httpAddConferenceSeriesAdmin)))
	r.HandleFunc(`/v2/conference_series/create`, httpWithContext(httpWithBasicAuth(httpCreateConferenceSeries)))
	r.HandleFunc(`/v2/conference_series/delete`, httpWithContext(httpWithBasicAuth(httpDeleteConferenceSeries)))
	...
	r.HandleFunc(`/v2/email/confirm`, httpWithContext(httpWithBasicAuth(httpConfirmTemporaryEmail)))
	r.HandleFunc(`/v2/email/create`, httpWithContext(httpWithBasicAuth(httpCreateTemporaryEmail)))
	r.HandleFunc(`/v2/external_resource/create`, httpWithContext(httpWithBasicAuth(httpCreateExternalResource)))
	r.HandleFunc(`/v2/external_resource/delete`, httpWithContext(httpWithBasicAuth(httpDeleteExternalResource)))
	...
	r.HandleFunc(`/v2/external_resource/update`, httpWithContext(httpWithBasicAuth(httpUpdateExternalResource)))
	r.HandleFunc(`/v2/featured_speaker/add`, httpWithContext(httpWithBasicAuth(httpAddFeaturedSpeaker)))
	r.HandleFunc(`/v2/featured_speaker/delete`, httpWithContext(httpWithBasicAuth(httpDeleteFeaturedSpeaker)))
	...
	r.HandleFunc(`/v2/featured_speaker/update`, httpWithContext(httpWithBasicAuth(httpUpdateFeaturedSpeaker)))
	r.HandleFunc(`/v2/question/create`, httpWithContext(httpWithBasicAuth(httpCreateQuestion)))
	r.HandleFunc(`/v2/question/delete`, httpWithContext(httpWithBasicAuth(httpDeleteQuestion)))
	r.HandleFunc(`/v2/question/list`, httpWithContext(httpWithOptionalBasicAuth(httpListQuestion)))
	r.HandleFunc(`/v2/room/create`, httpWithContext(httpWithBasicAuth(httpCreateRoom)))
	r.HandleFunc(`/v2/room/delete`, httpWithContext(httpWithBasicAuth(httpDeleteRoom)))
	...
	r.HandleFunc(`/v2/room/update`, httpWithContext(httpWithBasicAuth(httpUpdateRoom)))
	r.HandleFunc(`/v2/session/create`, httpWithContext(httpWithBasicAuth(httpCreateSession)))
	r.HandleFunc(`/v2/session/delete`, httpWithContext(httpWithBasicAuth(httpDeleteSession)))
	...
	r.HandleFunc(`/v2/session/send_all_selection_result_notification`, httpWithContext(httpWithBasicAuth(httpSendAllSelectionResultNotification)))
	r.HandleFunc(`/v2/session/send_selection_result_notification`, httpWithContext(httpWithBasicAuth(httpSendSelectionResultNotification)))
	r.HandleFunc(`/v2/session/update`, httpWithContext(httpWithBasicAuth(httpUpdateSession)))
	r.HandleFunc(`/v2/session/video_cover`, httpWithContext(httpWithBasicAuth(httpSetSessionVideoCover)))
	r.HandleFunc(`/v2/session_type/delete`, httpWithContext(httpWithBasicAuth(httpDeleteSessionType)))
	...
	r.HandleFunc(`/v2/session_type/update`, httpWithContext(httpWithBasicAuth(httpUpdateSessionType)))
	r.HandleFunc(`/v2/sponsor/add`, httpWithContext(httpWithBasicAuth(httpAddSponsor)))
	r.HandleFunc(`/v2/sponsor/delete`, httpWithContext(httpWithBasicAuth(httpDeleteSponsor)))
	...
	r.HandleFunc(`/v2/sponsor/update`, httpWithContext(httpWithBasicAuth(httpUpdateSponsor)))
	r.HandleFunc(`/v2/survey_session_response/create`, httpWithContext(httpWithBasicAuth(httpCreateSessionSurveyResponse)))
	r.HandleFunc(`/v2/track/create`, httpWithContext(httpWithBasicAuth(httpCreateTrack)))
	r.HandleFunc(`/v2/track/delete`, httpWithContext(httpWithBasicAuth(httpDeleteTrack)))
	r.HandleFunc(`/v2/track/lookup`, httpWithContext(httpLookupTrack))
	r.HandleFunc(`/v2/track/update`, httpWithContext(httpWithBasicAuth(httpUpdateTrack)))
	r.HandleFunc(`/v2/user/create`, httpWithContext(httpWithBasicAuth(httpCreateUser)))
	r.HandleFunc(`/v2/user/delete`, httpWithContext(httpWithBasicAuth(httpDeleteUser)))
	...
	r.HandleFunc(`/v2/user/update`, httpWithContext(httpWithBasicAuth(httpUpdateUser)))
	r.HandleFunc(`/v2/user/verify`, httpWithContext(httpWithBasicAuth(httpVerifyUser)))
	r.HandleFunc(`/v2/venue/create`, httpWithContext(httpWithBasicAuth(httpCreateVenue)))
	r.HandleFunc(`/v2/venue/delete`, httpWithContext(httpWithBasicAuth(httpDeleteVenue)))
	...
	r.HandleFunc(`/v2/venue/update`, httpWithContext(httpWithBasicAuth(httpUpdateVenue)))
}
