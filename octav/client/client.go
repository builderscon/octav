...
func (c *Client) CreateConference(in interface{}) (*octav.Conference, error) {
	var err error
...
func (c *Client) CreateRoom(in interface{}) (*octav.Room, error) {
	var err error
...
func (c *Client) CreateVenue(in *octav.Venue) (interface{}, error) {
	var err error
