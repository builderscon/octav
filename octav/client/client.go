...
func (c *Client) AddConferenceStaff(in *model.AddConferenceStaffRequest) (err error) {
	if pdebug.Enabled {
...
func (c *Client) CreateBlogEntry(in *model.CreateBlogEntryRequest) (ret *model.BlogEntry, err error) {
	if pdebug.Enabled {
...
func (c *Client) CreateExternalResource(in *model.CreateExternalResourceRequest) (ret *model.ExternalResource, err error) {
	if pdebug.Enabled {
	...
	var payload model.ExternalResource
	err = json.Unmarshal(jsonbuf.Bytes(), &payload)
	if err != nil {
		return nil, err
	}
...
func (c *Client) CreateTrack(in *model.CreateTrackRequest) (err error) {
	if pdebug.Enabled {
...
func (c *Client) DeleteBlogEntry(in *model.DeleteBlogEntryRequest) (err error) {
	if pdebug.Enabled {
...
func (c *Client) DeleteConferenceStaff(in *model.DeleteConferenceStaffRequest) (err error) {
	if pdebug.Enabled {
...
func (c *Client) DeleteExternalResource(in *model.DeleteExternalResourceRequest) (err error) {
	if pdebug.Enabled {
...
func (c *Client) DeleteTrack(in *model.DeleteTrackRequest) (err error) {
	if pdebug.Enabled {
...
func (c *Client) ListBlogEntries(in *model.ListBlogEntriesRequest) (ret []model.BlogEntry, err error) {
	if pdebug.Enabled {
...
func (c *Client) ListConferenceDate(in *model.ListConferenceDateRequest) (ret []model.ConferenceDate, err error) {
	if pdebug.Enabled {
...
func (c *Client) ListConferenceStaff(in *model.ListConferenceStaffRequest) (ret []model.User, err error) {
	if pdebug.Enabled {
...
func (c *Client) ListExternalResource(in *model.ListExternalResourceRequest) (ret []model.ExternalResource, err error) {
	if pdebug.Enabled {
...
func (c *Client) LookupBlogEntry(in *model.LookupBlogEntryRequest) (ret *model.BlogEntry, err error) {
	if pdebug.Enabled {
...
func (c *Client) LookupExternalResource(in *model.LookupExternalResourceRequest) (ret *model.ExternalResource, err error) {
	if pdebug.Enabled {
...
func (c *Client) LookupTrack(in *model.LookupTrackRequest) (ret *model.Venue, err error) {
	if pdebug.Enabled {
...
func (c *Client) SetSessionVideoCover(in *model.SetSessionVideoCoverRequest, files map[string]string) (err error) {
	if pdebug.Enabled {
	...
	if fn, ok := files["image"]; ok {
		fw, err := w.CreateFormFile("image", fn)
		if err != nil {
			return err
		}
		f, err := os.Open(fn)
...
func (c *Client) UpdateBlogEntry(in *model.UpdateBlogEntryRequest) (err error) {
	if pdebug.Enabled {
...
func (c *Client) UpdateExternalResource(in *model.UpdateExternalResourceRequest) (ret *model.ExternalResource, err error) {
	if pdebug.Enabled {
...
func (c *Client) UpdateTrack(in *model.UpdateTrackRequest) (err error) {
	if pdebug.Enabled {
