...
func (r *SendAllSelectionResultNotificationRequest) Populate(m map[string]interface{}) error {
	...
	if jv, ok := m["user_id"]; ok {
		...
		case string:
			...
			delete(m, "user_id")
		default:
			return errors.Wrap(ErrInvalidJSONFieldType{Field: "user_id"}, "failed to populate fields for SendAllSelectionResultNotificationRequest")
		}
	}
	return nil
}
...
func (r *AddConferenceStaffRequest) Populate(m map[string]interface{}) error {
	...
	if jv, ok := m["user_id"]; ok {
		...
		case string:
			...
			delete(m, "user_id")
		default:
			return errors.Wrap(ErrInvalidJSONFieldType{Field: "user_id"}, "failed to populate fields for AddConferenceStaffRequest")
		}
	}
	return nil
}
...
func (r *DeleteConferenceStaffRequest) Populate(m map[string]interface{}) error {
	...
	if jv, ok := m["user_id"]; ok {
		...
		case string:
			...
			delete(m, "user_id")
		default:
			return errors.Wrap(ErrInvalidJSONFieldType{Field: "user_id"}, "failed to populate fields for DeleteConferenceStaffRequest")
		}
	}
	return nil
}
...
func (r *ListConferenceStaffRequest) Populate(m map[string]interface{}) error {
	...
	if jv, ok := m["user_id"]; ok {
		...
		case string:
			...
			delete(m, "user_id")
		default:
			return errors.Wrap(ErrInvalidJSONFieldType{Field: "user_id"}, "failed to populate fields for ListConferenceStaffRequest")
		}
	}
	if jv, ok := m["lang"]; ok {
		if err := r.Lang.Set(jv); err != nil {
...
func (r *CreateExternalResourceRequest) Populate(m map[string]interface{}) error {
	...
	if jv, ok := m["name"]; ok {
		...
		case string:
			...
			delete(m, "name")
		default:
			return errors.Wrap(ErrInvalidJSONFieldType{Field: "name"}, "failed to populate fields for CreateExternalResourceRequest")
		}
	}
	if jv, ok := m["url"]; ok {
		switch jv.(type) {
